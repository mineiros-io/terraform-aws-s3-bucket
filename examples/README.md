...
- [examples/secure-s3-bucket] creates two secure AWS S3-Buckets using the `mineiros-io/terraform-aws-s3-bucket` module.

<!-- References -->

[examples/secure-s3-bucket]: https://github.com/mineiros-io/terraform-aws-s3-bucket/blob/master/examples/secure-s3-bucket
